...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        ...
        test_no_questions doesn’t create any questions, but checks the message: “No polls are available.”
    ...
    def test_past_question(self):
        """Questions with a pub_date in the past are displayed on the index page.
         test_past_question, we create a question and verify that it appears in the list.
        """
    ...
    def test_future_question(self):
        ...
        test_future_question, we create a question with a pub_date in the future.
        """
